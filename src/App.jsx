...
function App() {
  ...
  const filteredGrupos = grupos.filter((grupo) => {
    const matchesName = normalizeString(grupo.Nombre).includes(
      normalizeString(searchTerm)
    );
    const matchesYear =
      selectedYears.length === 0 || selectedYears.includes(grupo.Año);
  ...
  return (
    <div>
      ...
      <div className='container'>
        <h1 className='title'>Grupos de materias</h1>
                ...
                <tr key={index}>
                  ...
                  <td>
                    <button
                      ...
                      onClick={() => handleButtonClick(grupo.Link)}
                    >
